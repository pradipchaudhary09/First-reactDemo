...
const App = () => {
  const jobOpenings = [
    ...
    },
    {
      id: 4,
      brandLogo:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0fF2kcxLTOjYD-XN94f9C9VIgcwlklZ9uwQ&s",
      companyName: "Meta",
    ...
    },
    {
      id: 10,
      brandLogo:
        "https://substackcdn.com/image/fetch/$s_!aFzv!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa27a43b7-f1ec-4586-9898-5f43c9b7cdbf_1000x1000.jpegc",
      companyName: "IBM",
